package com.cognizant.leap.data.collector.gitlab.constants;
...
/**
 * Created by 784420 on 10/11/2019 7:19 PM
 */
public class Constants {
    private Constants() {}
    public static final String PRIVATE_TOKEN = "PRIVATE-TOKEN";
    public static final String COLLECTION_NAME_GITLAB_COMMITS = "gitlab_commits";
